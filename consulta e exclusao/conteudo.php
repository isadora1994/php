<?php
     ...
     $sql=mysqli_query($conecta, "SELECT* from tblusuario2 order by nome_tblusuario");
 ?>
<!DOCTYPE HTML>
<html>
     <head>
          ...
          <div id="conteudo">
               ...
               ?>
                     ...
                     <div class="content"><?php echo $result['nome_tblusuario']; ?></div>
                         ...
                         <div class="content last1"><a href="fupdate.php?id=<?php echo $row['id_tblusuario']; ?>">Atualizar</a></div>
                         <div class="content last1"><a href="excluir.php?id=<?php echo $row['id_tblusuario']; ?>">Excluir</a></div>
                         <div class="clear"></div>
               <?php } ?>
          </div>
     </body>
